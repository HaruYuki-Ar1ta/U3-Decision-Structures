...
public class Payroll {
    ...
    public static double normalWage(double normalHrs, double rate) {

        return normalHrs * rate;
    }

    public static double overtimeWage(double normalHrs, double rate) {
        double overtime = normalHrs - 40;
